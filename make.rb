...
# database shit
$client.query("DROP DATABASE IF EXISTS `beer1`;")
$client.query("CREATE DATABASE `beer1`;")
$client.select_db "beer1"
`mysql -ucsuser --password=c0rnd0gs -D beer1 < baralicious.sql`
